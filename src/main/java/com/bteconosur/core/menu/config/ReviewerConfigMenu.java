...
public class ReviewerConfigMenu extends Menu {
    ...
    protected BaseGui createGui() {
        ...
        gui.setItem(2, 2, MenuUtils.getReviewerConfigItem(language, "ds-notifications", configuration.getReviewerDsNotifications()));
        gui.addSlotAction(2, 2, event -> {
            ...
            gui.updateItem(2, 2, MenuUtils.getReviewerConfigItem(language, "ds-notifications", configuration.getReviewerDsNotifications()));
        });
