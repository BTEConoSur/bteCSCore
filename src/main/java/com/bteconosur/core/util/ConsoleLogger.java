...
public class ConsoleLogger {
    ...
    public static void warn(String message) {
        ...
        DiscordLogger.staffConsoleLog(LanguageHandler.getText("ds-warn-log").replace("%message%", message));
    }
    ...
    public static void error(String message) {
        ...
        DiscordLogger.staffConsoleLog(LanguageHandler.getText("ds-error-log").replace("%message%", message));
