...
public class UPlayerDsIdUsuarioCommand extends BaseCommand {

    private final YamlConfiguration lang;
    private final DBManager dbManager;

    public UPlayerDsIdUsuarioCommand() {
        super("dsidusuario", "Actualizar dsIdUsuario de un Player.", "<uuid> <valor>", CommandMode.BOTH);
        ConfigHandler configHandler = ConfigHandler.getInstance();
        lang = configHandler.getLang();
        dbManager = DBManager.getInstance();
    }

    //TODO: revisar a profundidad
