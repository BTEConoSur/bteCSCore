...
public class DCiudadCommand extends BaseCommand {

    private final YamlConfiguration lang;
    private final DBManager dbManager;

    public DCiudadCommand() {
        super("delete", "Eliminar Ciudad.", "<id>", CommandMode.BOTH);
    ...
    protected boolean onCommand(CommandSender sender, String[] args) {
        ...
        dbManager.remove(ciudad);

        String message = lang.getString("crud-delete").replace("%entity%", "Ciudad").replace("%id%", args[0]);
        PlayerLogger.info(sender, message, (String) null);
        return true;
    }
