...
public class UPaisDsIdGlobalChatCommand extends BaseCommand {
    ...
    public UPaisDsIdGlobalChatCommand() {
        super("dsidglobalchat", "Actualizar Discord Global Chat ID de un País.", "<id> <nuevo_ds_id_global_chat>", CommandMode.BOTH);
    ...
    protected boolean onCommand(CommandSender sender, String[] args) {
        ...
        String message = lang.getString("crud-update").replace("%entity%", "Pais").replace("%property%", "ds_id_global_chat");
        sender.sendMessage(message);
        return true;
    }
}
