...
public class RTipoProyectoCommand extends BaseCommand {

    private final DBManager dbManager;

    public RTipoProyectoCommand() {
        super("read", "<id>", "btecs.command.crud", CommandMode.BOTH);
    ...
    protected boolean onCommand(CommandSender sender, String[] args) {
        ...
        String message = LanguageHandler.getText(language, "crud.read").replace("%entity%", "Tipo de Proyecto").replace("%id%", args[0]);
