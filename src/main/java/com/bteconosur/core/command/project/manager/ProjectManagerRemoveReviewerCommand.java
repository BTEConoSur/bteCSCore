...
public class ProjectManagerRemoveReviewerCommand extends BaseCommand {

    private final YamlConfiguration lang;
    private final Set<String> paises = PaisRegistry.getInstance().getMap().keySet();

    public ProjectManagerRemoveReviewerCommand() {
        super("removereviewer", "Remover Reviewer de un país.", "<nombre_pais> <uuid/nombre_reviewer>", "btecs.command.project.manager.removereviewer", CommandMode.BOTH);
