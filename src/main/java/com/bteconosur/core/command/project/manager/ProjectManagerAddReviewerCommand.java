...
public class ProjectManagerAddReviewerCommand extends BaseCommand {

    private final YamlConfiguration lang;
    private final Set<String> paises = PaisRegistry.getInstance().getMap().keySet();

    public ProjectManagerAddReviewerCommand() {
        super("addreviewer", "Añadir Reviewer a un país.", "<nombre_pais> <uuid/nombre_reviewer>", "btecs.command.project.manager.addreviewer", CommandMode.BOTH);
