...
public class ProjectAdminCreateCommand extends BaseCommand {
    ...
    public ProjectAdminCreateCommand() {
        super("create", "[nombre]", "btecs.command.project.admin.create", CommandMode.PLAYER_ONLY);
    ...
    protected boolean onCommand(CommandSender sender, String[] args) {
        ...
        ProjectManager.getInstance().createAdminProject(nombre, regionPolygon, commandPlayer, language);
        return true;
    }
