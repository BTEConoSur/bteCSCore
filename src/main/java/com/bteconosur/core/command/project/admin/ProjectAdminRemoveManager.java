...
public class ProjectAdminRemoveManager extends BaseCommand {
    ...
    protected boolean onCommand(CommandSender sender, String[] args) {
        ...
        String countryLogMessage = lang.getString("manager-remove-log").replace("%staff%", staffName).replace("%player%", targetPlayer.getNombre()).replace("%pais%", pais.getNombrePublico());
