...
public class HelpMapaCommand extends BaseCommand {

    public HelpMapaCommand() {
        super("mapa", "", "btecs.command.help", CommandMode.PLAYER_ONLY);
    }
    ...
    protected boolean onCommand(CommandSender sender, String[] args) {
        ...
        List<String> lore = LanguageHandler.getTextList(language, "help-mapa");
