...
public class HelpWikiCommand extends BaseCommand {

    public HelpWikiCommand() {
        super("wiki", "", "btecs.command.help", CommandMode.PLAYER_ONLY);
    }
    ...
    protected boolean onCommand(CommandSender sender, String[] args) {
        ...
        List<String> lore = LanguageHandler.getTextList(language, "help-wiki");
