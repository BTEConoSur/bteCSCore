...
public class ManagerEditCommand extends BaseCommand {
    ...
    public ManagerEditCommand() {
        super("edit", "<id_proyecto>", "btecs.command.manager", CommandMode.PLAYER_ONLY);
    ...
    protected boolean onCommand(CommandSender sender, String[] args) {
        ...
        if (proyectoFinal.getEstado() != Estado.COMPLETADO) {
            PlayerLogger.error(commandPlayer, LanguageHandler.replaceMC("project.not-completed", language, proyectoFinal), (String) null);   
            return true;
        }
