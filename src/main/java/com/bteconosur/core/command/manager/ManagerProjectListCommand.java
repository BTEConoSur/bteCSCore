...
public class ManagerProjectListCommand extends BaseCommand {
    
    private ProjectListMenu menu;

    public ManagerProjectListCommand() {
        super("projectlist", "<nombre_jugador>", "btecs.command.project.list", CommandMode.PLAYER_ONLY);
