...
public class TourFirstCommand extends BaseCommand {

    public TourFirstCommand() {
        super("tourfirst", "", "btecs.command.tour", CommandMode.PLAYER_ONLY);
