...
public class TourStopEditPolygonCommand extends BaseCommand {

    public TourStopEditPolygonCommand() {
        super("polygon", "<id_tour> <id_parada>", "btecs.command.tour", CommandMode.PLAYER_ONLY);
