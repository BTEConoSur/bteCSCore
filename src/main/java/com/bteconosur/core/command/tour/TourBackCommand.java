...
public class TourBackCommand extends BaseCommand {

    public TourBackCommand() {
        super("tourback", "", "btecs.command.tour", CommandMode.PLAYER_ONLY);
    ...
    protected boolean onCommand(CommandSender sender, String[] args) {
        ...
        ts.previousStop(player.getUuid());
        return true;
    }
