...
public class TourStopEditPositionCommand extends BaseCommand {

    public TourStopEditPositionCommand() {
        super("position", "<id_tour> <id_parada>", "btecs.command.tour", CommandMode.PLAYER_ONLY);
