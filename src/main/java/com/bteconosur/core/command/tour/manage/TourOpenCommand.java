...
import com.bteconosur.core.menu.tour.TourParadaListMenu;
...
public class TourOpenCommand extends BaseCommand {

    public TourOpenCommand() {
        super("open", "<id_tour>", "btecs.command.tour", CommandMode.PLAYER_ONLY);
    ...
    protected boolean onCommand(CommandSender sender, String[] args) {
        ...
        new TourParadaListMenu(commandPlayer, tour, true).open();
        return true;
    }
