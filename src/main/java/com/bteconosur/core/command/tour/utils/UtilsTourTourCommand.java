...
public class UtilsTourTourCommand extends BaseCommand {

    public UtilsTourTourCommand() {
        super("tour", "<id_tour>", "btecs.command.tour", CommandMode.PLAYER_ONLY);
    ...
    protected boolean onCommand(CommandSender sender, String[] args) {
        ...
        if (ts.isInTour(commandPlayer.getUuid())) {
            return true;
        }

        ts.startTour(commandPlayer, tour);
        return true;
    }
